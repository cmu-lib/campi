      ...
      <b-row flex align-h="between">
        ...
        <b-button-toolbar>
          <b-button
            ...
            @click="photo_search"
            v-b-tooltip.hover
            title="This photo may appear in other sets based on the way it was added to this set during automatic clustering. Click to search for any other sets it MAY be in."
          >
            <BIconSearch />
          </b-button>
          <b-button-group>
